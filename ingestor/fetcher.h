...
/// Función para devolver los últimos 3 archivos .nc del servicio meteorológico
...
/// Función de apoyo para que la thread desde la que se lanza download_parallel
/// espere a que esta se complete. Es llamada desde dentro de download_parallel
/// unicamente.
...
/// Bien simple de entender. Observa un url y determina compara el tiempo con un
/// archivo.
